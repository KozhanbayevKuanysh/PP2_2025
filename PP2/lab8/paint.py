...
def submaterials():
    pygame.draw.rect(buttons_bar, BLACK, (2, 2, 96, 240), 1) 
    ...
    pygame.draw.rect(buttons_bar, BLACK, (56, 58, 34, 28))
    ...
    f = font.render('6 - Orange', True, 'black')
    buttons_bar.blit(f, (5, 220))
